...
class DocumentStore:
    ...
    def load_and_preprocess(self):
        ...
        if os.path.exists('doc_store_documents_glove.pkl'):
            with open('doc_store_documents_glove.pkl', 'rb') as f:
                self.documents = pickle.load(f)
            with open('doc_store_collection_tokens_glove.pkl', 'rb') as f:
        ...
        # t = 0
            ...
            with open('doc_store_documents_glove.pkl', 'wb') as f:
                pickle.dump(self.documents, f)

            with open('doc_store_collection_tokens_glove.pkl', 'wb') as f:
